...
const getBookmarkPages = () => {
  return [
    ...
    {
      pageId: 1760173251111,
      title: 'Edge收藏夹',
      default: true,
      createAt: 1760173251111,
      updateAt: 1760173251111
    },
    {
      pageId: 1760173696766,
      title: 'Chrome书签',
      default: false,
      createAt: 1760173696766,
      updateAt: 1760173696766
    }
  ];
};
setupMock({
  setup: () => {
    ...
    Mock.mock(new RegExp('/api/page/list'), () => {
      return getBookmarkPages();
    });
