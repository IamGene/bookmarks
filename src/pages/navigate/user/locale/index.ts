const i18n = {
  'en-US': {
    ...
    'cardList.tab.title.tags': 'Website tags',
    ...
    'cardList.select.group.placeholder': 'Please select ...',
    'cardList.edit.website.tag': 'Edit website url',
    'cardList.move.bookmarks': 'Move bookmarks to',
    'cardList.move.bookmarks.list': 'Bookmark List',
    'modal.message.move.bookmarks.empty': 'Bookmark list is empty, please select again',
    'modal.message.move.bookmarks.success': 'Bookmarks moved successfully',
  ...
  'zh-CN': {
    ...
    'cardList.move.bookmarks': '移动书签到',
    'cardList.move.bookmarks.list': '书签列表',
    ...
    'modal.message.move.bookmarks.empty': '书签列表为空，请重新选择',
    'modal.message.move.bookmarks.success': '移动成功',
    'cardList.enable': '启用',
    'cardList.disable': '禁用',
    'cardList.action': '操作',
