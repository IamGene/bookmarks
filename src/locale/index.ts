const i18n = {
  'en-US': {
    ...
    'menu.list.navigateList': 'Navigate List',
    // 新增
    'menu.list.test': 'Demo Test',
    'menu.navigate': 'Navigate',
    'menu.navigate.default': 'Navigate Default',
    'menu.navigate.user': 'Navigate User',
    ...
    'bookmarks.page.group.create': 'Click to create new Page or Group',
    'bookmarks.page.duplicated.find': 'Click to find duplicated bookmarks',
    'bookmarks.page.home': 'Home Page',
    'bookmarks.page.home.tips': 'You are already on the home page!',
    ...
    'settings.navbar.plugin.download': 'Click to download plugin',
    'settings.tags.show': 'Click to show tags',
    'settings.tags.hide': 'Click to hide tags',
    'settings.menu': 'Menu',
  ...
  'zh-CN': {
    ...
    'menu.list.navigateList': '导航列表',
    'menu.list.test': '测试',
    'menu.navigate': '导航',
    'menu.navigate.default': '默认导航',
    'menu.navigate.user': '用户导航',
    ...
    'navbar.logout': '退出登录',
    'bookmarks.page.group.create': '点击创建书签页或分组',
    'bookmarks.page.duplicated.find': '点击检测重复书签',
    'settings.title': '页面配置',
    ...
    'settings.navbar.plugin.download': '点击下载插件',
    'settings.tags.show': '点击显示分组和标签',
    'settings.tags.hide': '点击隐藏分组和标签',
    'settings.menu': '菜单栏',
    'settings.footer': '底部',
